...
namespace pllllllll
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            var persons = EmptyClass2.InitialPersonList();

            var a = EmptyClass2.AverageAge(persons);
            Console.ReadKey();
            ...
            Console.WriteLine("--------------------------------------------------------------------------");
            var provinces = EmptyClass2.GetProvinces(persons);
            ...
            Console.WriteLine("--------------------------------------------------------------------------");
            var provinces01 = EmptyClass2.GetProvincesGroupBy(persons);
            ...
            Console.WriteLine("--------------------------------------------------------------------------");
            var provinceData = EmptyClass2.GetProvincesPersons(persons);
